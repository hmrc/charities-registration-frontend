...
class AppConfig @Inject()(val runModeConfiguration: Configuration,
  ...
  lazy val signIn = servicesConfig.getString("govuk-tax.auth.login")  //"sign-in-local"
  lazy val loginCallback = servicesConfig.getString("govuk-tax.auth.loginContinue")
  ...
  lazy val mongoLongTimeToSave: Int = servicesConfig.getInt("mongodb.longTimeToLiveInSeconds")
  lazy val mongoShortTimeToSave: Int = servicesConfig.getInt("mongodb.shortTimeToLiveInSeconds")

  lazy val appName = servicesConfig.getString("appName")
  lazy val appCacheName = servicesConfig.getString("appCacheName")
}