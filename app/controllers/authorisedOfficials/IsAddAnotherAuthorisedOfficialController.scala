  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      getFullName(AuthorisedOfficialsNamePage(0)) { authorisedOfficialsName =>
        ...
        Future.successful(getView(IsAddAnotherAuthorisedOfficialPage, form, authorisedOfficialsName, None,
  ...
  def onSubmit(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      getFullName(AuthorisedOfficialsNamePage(0)) { authorisedOfficialsName =>
        ...
        postView(mode, IsAddAnotherAuthorisedOfficialPage, form, authorisedOfficialsName, None,
