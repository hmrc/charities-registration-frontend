...
class AmendNomineeIndividualAddressController @Inject()(
  ...
  override val messagePrefix: String = "amendNomineeIndividualAddress"
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      getFullName(IndividualNomineeNamePage) { individualNomineeName =>
        ...
        Future.successful(getView(NomineeIndividualAddressLookupPage,
          controllers.nominees.routes.AmendNomineeIndividualAddressController.onSubmit(mode),
  ...
  def onSubmit(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      getFullName(IndividualNomineeNamePage) { individualNomineeName =>
        ...
        postView(mode, NomineeIndividualAddressLookupPage, Section9Page,
          controllers.nominees.routes.AmendNomineeIndividualAddressController.onSubmit(mode),
          countryService.countries(), Some(individualNomineeName))
      }
  }
