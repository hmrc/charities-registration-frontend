...
object CharitablePurposes extends Enumerable.Implicits[CharitablePurposes] {
  ...
  implicit val setWrites: Writes[Set[CharitablePurposes]] = Writes.iterableWrites2[CharitablePurposes, Set[CharitablePurposes]]
