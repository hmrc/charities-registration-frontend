...
class NomineesNavigator @Inject()(implicit frontendAppConfig: FrontendAppConfig) extends BaseNavigator {
  ...
  override val normalRoutes: Page => UserAnswers => Call = {
    ...
    case NomineeIndividualAddressLookupPage => userAnswers: UserAnswers =>
      userAnswers.get(NomineeIndividualAddressLookupPage) match {
        case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeIndividualAddressController.onPageLoad(NormalMode)
    ...
    case NomineeIndividualPreviousAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(NomineeIndividualPreviousAddressLookupPage) match {
        case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeIndividualPreviousAddressController.onPageLoad(NormalMode)
    ...
    case OrganisationNomineeAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(OrganisationNomineeAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeOrganisationAddressController.onPageLoad(NormalMode)
    ...
    case OrganisationNomineePreviousAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(OrganisationNomineePreviousAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeOrganisationPreviousAddressController.onPageLoad(NormalMode)
  ...
  override val checkRouteMap: Page => UserAnswers => Call = {
    ...
    case NomineeIndividualAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(NomineeIndividualAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeIndividualAddressController.onPageLoad(CheckMode)
    ...
    case NomineeIndividualPreviousAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(NomineeIndividualPreviousAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeIndividualPreviousAddressController.onPageLoad(CheckMode)
      case Some(_) => nomineeRoutes.NomineeDetailsSummaryController.onPageLoad()
      case _ => routes.PageNotFoundController.onPageLoad()
    }
    ...
    case OrganisationNomineeAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(OrganisationNomineeAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeOrganisationAddressController.onPageLoad(CheckMode)
    ...
    case OrganisationNomineePreviousAddressLookupPage => userAnswers: UserAnswers => userAnswers.get(OrganisationNomineePreviousAddressLookupPage) match {
      case Some(address) if address.lines.exists(_.length > 35) => nomineeRoutes.AmendNomineeOrganisationPreviousAddressController.onPageLoad(CheckMode)
      case Some(_) => nomineeRoutes.NomineeDetailsSummaryController.onPageLoad()
      case _ => routes.PageNotFoundController.onPageLoad()
    }
