...
class TaskListHelper {
  ...
  implicit class TaskList(val userAnswers: UserAnswers) {
    ...
    val section6: Boolean => TaskListRow = (isDependent: Boolean) =>
      getSection(
  ...
  def getTaskListRow(implicit userAnswers: UserAnswers): List[TaskListRow] = {
    ...
    val result = List(
      ...
      userAnswers.section3(),
      userAnswers.section4(),
      userAnswers.section5(),
      userAnswers.section6(userAnswers.section1().state.contains("completed")),
      userAnswers.userAnswers.section7(),
      userAnswers.section8(),
      userAnswers.section9()
    )
  ...
  private def getSection(
    ...
    normalUrl: Call,
    changeUrl: Call,
    sectionId: QuestionPage[Boolean],
    isDependent: Option[Boolean] = None
