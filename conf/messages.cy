...
bankDetails.accountNumber.error.required = (W)Account number must be written as a number, like 00733445(W)
...
authorisedOfficialsName.firstName.error.format = (W)First name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
authorisedOfficialsName.middleName.error.format = (W)Middle name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
authorisedOfficialsName.lastName.error.format = (W)Last name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
authorisedOfficialsPassport.passportNumber.error.format= (W)Passport or national identity card number must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
authorisedOfficialsPassport.passportNumber.error.required = (W)Enter their passport or national identity card number(W)
...
authorisedOfficialsNino.error.format = (W)National Insurance number must only include letters and numbers(W)
...
otherOfficialsName.firstName.error.format = (W)First name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
otherOfficialsName.middleName.error.format = (W)Middle name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
otherOfficialsName.lastName.error.format = (W)Last name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
otherOfficialsPassport.passportNumber.error.format= (W)Passport or national identity card number must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
otherOfficialsPassport.passportNumber.error.required = (W)Enter their passport or national identity card number(W)
...
otherOfficialsNino.error.format = (W)National Insurance number must only include letters and numbers(W)
...
individualNomineeName.firstName.error.format = (W)First name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
individualNomineeName.middleName.error.format = (W)Middle name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
individualNomineeName.lastName.error.format = (W)Last name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
individualNomineesNino.error.format = (W)National Insurance number must only include letters and numbers(W)
...
individualNomineesBankDetails.accountName.error.format = (W)Account name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
individualNomineesBankDetails.rollNumber.error.format = (W)Roll number must only include letters, numbers, spaces, hyphens and forward slashes(W)
...
nameOfOrganisation.error.format = (W)Name of the organisation must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
organisationNomineesBankDetails.accountName.error.format = (W)Account name must only include letters, numbers, hyphens, apostrophes, commas and spaces(W)
...
organisationNomineesBankDetails.rollNumber.error.format = (W)Roll number must only include letters, numbers, spaces, hyphens and forward slashes(W)
