...
index.section2.spoke2.label = (W)Governing document(W)
index.section.numbers3 = (W)3.(W)
index.section3.label = (W)Operations and funds(W)
index.section3.spoke1.label = (W)Objectives(W)
index.section3.spoke2.label = (W)Fundraising information(W)
index.section3.spoke3.label = (W)Bank details(W)
index.section.numbers4 = (W)4.(W)
index.section4.label = (W)Officials and nominee(W)
index.section4.spoke1.label = (W)Authorised officials(W)
index.section4.spoke2.label = (W)Other officials(W)
index.section4.spoke3.label = (W)Nominee(W)
index.section.note.label = (W)Once you have completed every section, you will be asked to sign a declaration and send the application.(W)
...
authorisedOfficialsPosition.01 = (W)Board member(W)
authorisedOfficialsPosition.02 = (W)Bursar(W)
authorisedOfficialsPosition.03 = (W)Chairman(W)
authorisedOfficialsPosition.04 = (W)Chief executive(W)
authorisedOfficialsPosition.05 = (W)Director(W)
authorisedOfficialsPosition.06 = (W)Employee(W)
authorisedOfficialsPosition.07 = (W)Finance manager(W)
authorisedOfficialsPosition.08 = (W)Financial accountant(W)
authorisedOfficialsPosition.09 = (W)Gift aid secretary(W)
authorisedOfficialsPosition.10 = (W)Governor (Schools and Academies)(W)
authorisedOfficialsPosition.11 = (W)Head teacher(W)
authorisedOfficialsPosition.12 = (W)Assistant head teacher(W)
authorisedOfficialsPosition.13 = (W)Human resources manager(W)
authorisedOfficialsPosition.14 = (W)Information officer(W)
authorisedOfficialsPosition.15 = (W)Minister of religion(W)
authorisedOfficialsPosition.16 = (W)Principal(W)
authorisedOfficialsPosition.17 = (W)Secretary(W)
authorisedOfficialsPosition.18 = (W)Assistant secretary(W)
authorisedOfficialsPosition.19 = (W)Teacher(W)
authorisedOfficialsPosition.20 = (W)Treasurer(W)
