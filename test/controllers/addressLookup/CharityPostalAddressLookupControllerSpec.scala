...
class CharityPostalAddressLookupControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private lazy val controller: CharityPostalAddressLookupController = new CharityPostalAddressLookupController(mockUserAnswerRepository,
