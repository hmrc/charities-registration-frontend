...
class NomineeIndividualPreviousAddressLookupControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private lazy val controller: NomineeIndividualPreviousAddressLookupController = new NomineeIndividualPreviousAddressLookupController(mockUserAnswerRepository,
