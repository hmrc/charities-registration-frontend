...
class OrganisationNomineePreviousAddressLookupControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "OrganisationNomineePreviousAddressLookupController" when {
        ...
        "an ID is provided" when {
          ...
          "an address is retrieved" must {
            ...
            "redirect to the next page" in {
              ...
              val result = controller.callback(NormalMode, Some(addressId))(fakeDataRequest)
          ...
          "redirect to Session Expired for a GET if no existing data is found" in {
            ...
            val result = controller.callback(NormalMode, Some(addressId))(fakeRequest)
