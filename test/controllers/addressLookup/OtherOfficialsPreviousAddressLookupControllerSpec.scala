...
class OtherOfficialsPreviousAddressLookupControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private lazy val controller: OtherOfficialsPreviousAddressLookupController =
    new OtherOfficialsPreviousAddressLookupController(
      mockUserAnswerService,
      FakeOtherOfficialsNavigator,
  ...
  "OtherOfficialsPreviousAddressLookup Controller" when {
