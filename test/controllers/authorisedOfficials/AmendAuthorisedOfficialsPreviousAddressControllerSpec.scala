...
class AmendAuthorisedOfficialsPreviousAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val controller: AmendAuthorisedOfficialsPreviousAddressController =
    inject[AmendAuthorisedOfficialsPreviousAddressController]
  ...
  "AmendAuthorisedOfficialsPreviousAddressController Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(
        form.fill(amendAuthorisedOfficialsPreviousAddress),
        messageKeyPrefix,
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = localUserAnswers
        .set(AmendAddressPage, AmendAddressModel("23", Some("Morrison street"), None, "Glasgow", "G58AN", gbCountry.code))
        .success
        .value
