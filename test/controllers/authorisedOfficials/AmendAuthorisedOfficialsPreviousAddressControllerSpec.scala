...
class AmendAuthorisedOfficialsPreviousAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val messageKeyPrefix = "amendAuthorisedOfficialPreviousAddress"
  ...
  private val controller: AmendAuthorisedOfficialsPreviousAddressController = inject[AmendAuthorisedOfficialsPreviousAddressController]

  private val requestArgs = Seq("line1" -> "23", "line2" -> "Morrison street", "line3" -> "",
    "town" -> "Glasgow",
    "postcode" -> "G58AN",
    "country" -> "GB")
  private val localUserAnswers: UserAnswers = emptyUserAnswers.set(AuthorisedOfficialPreviousAddressLookupPage(0),
    AddressModel(Seq("7", "Morrison street near riverview gardens", "Glasgow"), Some("G58AN"), CountryModel("GB", "United Kingdom")))
    .flatMap(_.set(AuthorisedOfficialsNamePage(0), Name(SelectTitle.Mr, "Jim", Some("John"), "Jones"))).success.value


  "AmendAuthorisedOfficialsPreviousAddressController Controller " must {

    "return OK and the correct view for a GET" in {

      val amendAuthorisedOfficialsPreviousAddress = AmendAddressModel("7", Some("Morrison street near riverview gardens"), Some(""), "Glasgow", "G58AN", "GB")
      ...
      contentAsString(result) mustEqual view(form.fill(amendAuthorisedOfficialsPreviousAddress), messageKeyPrefix,
        controllers.authorisedOfficials.routes.AmendAuthorisedOfficialsPreviousAddressController.onSubmit(NormalMode, Index(0)),
        Some("Jim John Jones"), Seq(("GB", "United Kingdom")))(fakeRequest, messages, frontendAppConfig).toString
