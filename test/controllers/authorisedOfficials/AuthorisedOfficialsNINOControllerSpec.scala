...
import pages.authorisedOfficials.{AuthorisedOfficialsNINOPage, AuthorisedOfficialsNamePage}
...
class AuthorisedOfficialsNINOControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: AuthorisedOfficialsNINOView = inject[AuthorisedOfficialsNINOView]
  private val formProvider: AuthorisedOfficialsNINOFormProvider = inject[AuthorisedOfficialsNINOFormProvider]
