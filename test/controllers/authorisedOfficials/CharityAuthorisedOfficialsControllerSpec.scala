...
class CharityAuthorisedOfficialsControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: CharityAuthorisedOfficialsView = injector.instanceOf[CharityAuthorisedOfficialsView]
