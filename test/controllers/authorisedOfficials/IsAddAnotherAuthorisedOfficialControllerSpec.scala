...
class IsAddAnotherAuthorisedOfficialControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "IsAddAnotherAuthorisedOfficialController Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(form, "Jim John Jones", None, messageKeyPrefix,
