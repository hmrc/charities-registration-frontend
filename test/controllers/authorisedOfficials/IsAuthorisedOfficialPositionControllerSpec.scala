...
import pages.authorisedOfficials.{AuthorisedOfficialsNamePage, IsAuthorisedOfficialPositionPage}
...
class IsAuthorisedOfficialPositionControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: IsAuthorisedOfficialPositionView = injector.instanceOf[IsAuthorisedOfficialPositionView]
  private val formProvider: IsAuthorisedOfficialPositionFormProvider = injector.instanceOf[IsAuthorisedOfficialPositionFormProvider]
  private val form: Form[Boolean] = formProvider()

  private val controller: IsAuthorisedOfficialPositionController = inject[IsAuthorisedOfficialPositionController]
  ...
  "IsAuthorisedOfficialPosition Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      when(mockUserAnswerRepository.get(any())).thenReturn(Future.successful(Some(localUserAnswers.
        set(IsAuthorisedOfficialPositionPage(0), true).getOrElse(emptyUserAnswers))))
