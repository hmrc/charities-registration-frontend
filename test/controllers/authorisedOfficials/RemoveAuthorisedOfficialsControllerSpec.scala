...
class RemoveAuthorisedOfficialsControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val localUserAnswers: UserAnswers =
    emptyUserAnswers
      ...
      .flatMap(_.set(AuthorisedOfficialsNamePage(1), personName2WithMiddle))
      .success
      .value
