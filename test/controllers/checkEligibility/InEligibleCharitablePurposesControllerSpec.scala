...
class InEligibleCharitablePurposesControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: InEligibleCharitablePurposesView = injector.instanceOf[InEligibleCharitablePurposesView]
