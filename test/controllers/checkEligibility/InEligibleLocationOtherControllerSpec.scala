...
class InEligibleLocationOtherControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: InEligibleLocationOtherView = injector.instanceOf[InEligibleLocationOtherView]
