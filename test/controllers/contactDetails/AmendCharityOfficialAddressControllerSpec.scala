...
class AmendCharityOfficialAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val requestArgs = Seq("line1" -> "23", "line2" -> "Morrison street", "line3" -> "",
    ...
    "postcode" -> "G58AN",
    "country" -> "GB")
  private val localUserAnswers: UserAnswers = emptyUserAnswers.set(CharityOfficialAddressLookupPage,
  ...
  "AmendCharityOfficialAddressController Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val amendCharitiesOfficialsAddress = AmendAddressModel("7", Some("Morrison street near riverview gardens"), Some(""), "Glasgow", "G58AN", "GB")
      ...
      contentAsString(result) mustEqual view(form.fill(amendCharitiesOfficialsAddress), messageKeyPrefix,
