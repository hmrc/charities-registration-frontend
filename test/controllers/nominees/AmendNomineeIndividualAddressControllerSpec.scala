...
class AmendNomineeIndividualAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val requestArgs = Seq("line1" -> "23", "line2" -> "Morrison street", "line3" -> "",
    ...
    "postcode" -> "G58AN",
    "country" -> "GB")
  private val localUserAnswers: UserAnswers = emptyUserAnswers.set(NomineeIndividualAddressLookupPage,
    AddressModel(Seq("7", "Morrison street near riverview gardens", "South side", "Glasgow"), Some("G58AN"), CountryModel("GB", "United Kingdom")))
  ...
  "AmendNomineeIndividualAddressController Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val amendNomineeIndividualAddress = AmendAddressModel("7", Some("Morrison street near riverview gardens"), Some("South side"), "Glasgow", "G58AN", "GB")
      ...
      contentAsString(result) mustEqual view(form.fill(amendNomineeIndividualAddress), messageKeyPrefix,
