...
class AmendNomineeOrganisationPreviousAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val controller: AmendNomineeOrganisationPreviousAddressController = inject[AmendNomineeOrganisationPreviousAddressController]
  ...
  private val localUserAnswers: UserAnswers = emptyUserAnswers.set(OrganisationNomineePreviousAddressLookupPage,
  ...
  "AmendNomineeOrganisationAddressController Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val amendNomineeOrganisationPreviousAddress = AmendAddressModel("7", Some("Morrison street near riverview gardens"), Some(""), "Glasgow", "G58AN", "GB")
      ...
      contentAsString(result) mustEqual view(form.fill(amendNomineeOrganisationPreviousAddress), messageKeyPrefix,
