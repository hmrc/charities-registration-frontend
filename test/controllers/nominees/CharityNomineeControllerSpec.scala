...
class CharityNomineeControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: CharityNomineeView = injector.instanceOf[CharityNomineeView]

  private val controller: CharityNomineeController = inject[CharityNomineeController]

  "CharityNominee Controller " must {
