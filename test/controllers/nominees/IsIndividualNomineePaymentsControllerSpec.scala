...
class IsIndividualNomineePaymentsControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: IsIndividualNomineePaymentsView = injector.instanceOf[IsIndividualNomineePaymentsView]
  private val formProvider: IsIndividualNomineePaymentsFormProvider = injector.instanceOf[IsIndividualNomineePaymentsFormProvider]
  ...
  "IsIndividualNomineePayments Controller " must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(form, NormalMode, "Jim John Jones")(fakeRequest, messages, frontendAppConfig).toString
