...
class CharitablePurposesControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "CharitablePurposes Controller " must {
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = fakeRequest.withFormUrlEncodedBody(("value[0]", CharitablePurposes.values.head.toString))
