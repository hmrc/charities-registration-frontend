...
class StartCharitableObjectivesControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: StartCharitableObjectivesView = injector.instanceOf[StartCharitableObjectivesView]
