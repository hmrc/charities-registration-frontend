...
class StartFundraisingControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: StartFundraisingView = injector.instanceOf[StartFundraisingView]
