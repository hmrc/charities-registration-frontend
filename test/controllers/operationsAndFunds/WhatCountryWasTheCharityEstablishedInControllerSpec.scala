...
class CharityEstablishedInControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "WhatCountryWasTheCharityEstablishedIn Controller " must {
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request = fakeRequest.withFormUrlEncodedBody(("value", CharityEstablishedOptions.values.head.toString))
