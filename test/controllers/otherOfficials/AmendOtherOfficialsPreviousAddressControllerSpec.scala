...
class AmendOtherOfficialsPreviousAddressControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val messageKeyPrefix = "amendOtherOfficialPreviousAddress"
  ...
  private val controller: AmendOtherOfficialsPreviousAddressController = inject[AmendOtherOfficialsPreviousAddressController]

  private val requestArgs = Seq("line1" -> "23", "line2" -> "Morrison street", "line3" -> "",
    "town" -> "Glasgow",
    "postcode" -> "G58AN",
    "country" -> "GB")
  private val localUserAnswers: UserAnswers = emptyUserAnswers.set(OtherOfficialPreviousAddressLookupPage(0),
  ...
  "AmendOtherOfficialsPreviousAddressController Controller " must {

    "return OK and the correct view for a GET" in {

      val amendOtherOfficialsPreviousAddress = AmendAddressModel("7", Some("Morrison street near riverview gardens"), Some(""), "Glasgow", "G58AN", "GB")
      ...
      contentAsString(result) mustEqual view(form.fill(amendOtherOfficialsPreviousAddress), messageKeyPrefix,
