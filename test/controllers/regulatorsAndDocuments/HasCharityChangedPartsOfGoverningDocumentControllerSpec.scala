...
import pages.regulatorsAndDocuments.{HasCharityChangedPartsOfGoverningDocumentPage, SelectGoverningDocumentPage}
...
class HasCharityChangedPartsOfGoverningDocumentControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  "HasCharityChangedPartsofGoverningDocument Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(form, NormalMode, "will")(fakeRequest, messages, frontendAppConfig).toString
