...
class IsCharityRegulatorControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  val view: IsCharityRegulatorView = inject[IsCharityRegulatorView]
  val formProvider: IsCharityRegulatorFormProvider = inject[IsCharityRegulatorFormProvider]
  val form = formProvider()

  val controller: IsCharityRegulatorController = inject[IsCharityRegulatorController]
