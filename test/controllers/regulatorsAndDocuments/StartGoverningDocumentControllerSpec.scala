...
class StartGoverningDocumentControllerSpec extends SpecBase with BeforeAndAfterEach {
  ...
  private val view: StartGoverningDocumentView = injector.instanceOf[StartGoverningDocumentView]
