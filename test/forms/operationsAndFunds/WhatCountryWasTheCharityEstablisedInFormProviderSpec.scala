...
class WhatCountryWasTheCharityEstablisedInFormProviderSpec extends OptionFieldBehaviours {

  private val form: Form[CharityEstablishedOptions] = inject[CharityEstablishedInFormProvider].apply()
