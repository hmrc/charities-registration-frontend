...
class CharityOfficialAddressLookupPageSpec extends PageBehaviours {
  ...
  "CharityOfficialAddressLookupPage" must {
    ...
    beSettable[AddressModel](CharityOfficialAddressLookupPage)

    beRemovable[AddressModel](CharityOfficialAddressLookupPage)
  }
}
