...
class NomineeIndividualAddressLookupPageSpec extends PageBehaviours {
  ...
  "NomineeIndividualAddressLookupPage" must {
    ...
    beRetrievable[AddressModel](NomineeIndividualAddressLookupPage)

    beSettable[AddressModel](NomineeIndividualAddressLookupPage)

    beRemovable[AddressModel](NomineeIndividualAddressLookupPage)
  }
}
