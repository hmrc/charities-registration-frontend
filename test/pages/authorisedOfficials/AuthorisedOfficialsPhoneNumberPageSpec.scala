...
class AuthorisedOfficialsPhoneNumberPageSpec extends PageBehaviours {

  "AuthorisedOfficialsPhoneNumber Page" must {

    implicit lazy val arbitraryAuthorisedOfficialsPhoneNumber: Arbitrary[PhoneNumber] = Arbitrary(phoneNumbers)
