...
class FundRaisingPageSpec extends PageBehaviours{
  ...
  "FundRaisingPage" must {
    ...
    beRetrievable[Set[FundRaisingOptions]](FundRaisingPage)

    beSettable[Set[FundRaisingOptions]](FundRaisingPage)

    beRemovable[Set[FundRaisingOptions]](FundRaisingPage)
