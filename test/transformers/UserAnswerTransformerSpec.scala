  ...
  "UserAnswerTransformer" when {
    ...
    "toUserAnswerCharityContactDetails" must {
      ...
      "convert the ContactDetails" in {
        Json
          .obj("charityContactDetails" -> Json.toJson(contactDetails))
          .transform(jsonTransformer.toUserAnswerCharityContactDetails)
          .asOpt
          .value mustBe Json.obj(
    ...
    "toUserAnswerCharityOfficialAddress" must {
      ...
      "convert the OfficialAddress" in {
        Json
          .obj("charityOfficialAddress" -> Json.toJson(charityAddress))
          .transform(jsonTransformer.toUserAnswerCharityOfficialAddress)
          .asOpt
          .value mustBe Json.obj(
    ...
    "toUserAnswerCorrespondenceAddress" must {
      ...
      "convert the CorrespondenceAddress" in {
        Json
          .obj("correspondenceAddress" -> Json.toJson(correspondenceAddress))
          .transform(jsonTransformer.toUserAnswerCorrespondenceAddress)
          .asOpt
          .value mustBe Json.obj(
    ...
    "toUserAnswersCharityRegulator" must {
      ...
      "convert to correct charityRegulator5" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator5))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
            |"selectWhyNoRegulator":"1","whyNotRegisteredWithCharity":"Reason"}""".stripMargin)
      }

      "convert to correct charityRegulator6" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator6))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
      ...
      "convert to correct charityRegulator7" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator7))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
      ...
      "convert to correct charityRegulator8" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator8))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
      ...
      "convert to correct charityRegulator9" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator9))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
      ...
      "convert to correct charityRegulator10" in {
        Json
          .obj("charityRegulator" -> Json.toJson(noCharityRegulator10))
          .transform(jsonTransformer.toUserAnswersCharityRegulator)
          .asOpt
          .value mustBe Json.parse("""{"isSection2Completed":false,"isCharityRegulator":false,
    ...
    "toUserAnswersCharityGoverningDocument" must {
      ...
      "convert to correct GoverningDocument for document 1" in {
        Json
          .obj("charityGoverningDocument" -> Json.toJson(charityGoverningDocument1))
          .transform(jsonTransformer.toUserAnswersCharityGoverningDocument)
          .asOpt
      ...
      "convert to correct GoverningDocument for document 3" in {
        Json
          .obj("charityGoverningDocument" -> Json.toJson(charityGoverningDocument3))
          .transform(jsonTransformer.toUserAnswersCharityGoverningDocument)
          .asOpt
          .value mustBe Json.parse(
          """{"whenGoverningDocumentApproved":"1990-11-11","isApprovedGoverningDocument":true,"isSection3Completed":false,
      ...
      "convert to correct GoverningDocument for document 4" in {
        Json
          .obj("charityGoverningDocument" -> Json.toJson(charityGoverningDocument4))
          .transform(jsonTransformer.toUserAnswersCharityGoverningDocument)
          .asOpt
          .value mustBe Json.parse(
          """{"whenGoverningDocumentApproved":"1990-11-11","isApprovedGoverningDocument":true,"isSection3Completed":false,
      ...
      "convert to correct GoverningDocument for document 6" in {
        Json
          .obj("charityGoverningDocument" -> Json.toJson(charityGoverningDocument6))
          .transform(jsonTransformer.toUserAnswersCharityGoverningDocument)
          .asOpt
          .value mustBe Json.parse(
          """{"whenGoverningDocumentApproved":"1990-11-11","isApprovedGoverningDocument":true,"isSection3Completed":false,
      ...
      "convert to correct GoverningDocument for document 7" in {
        Json
          .obj("charityGoverningDocument" -> Json.toJson(charityGoverningDocument7))
          .transform(jsonTransformer.toUserAnswersCharityGoverningDocument)
          .asOpt
          .value mustBe Json.parse(
          """{"whenGoverningDocumentApproved":"1990-11-11","isApprovedGoverningDocument":true,"isSection3Completed":false,
    ...
    "toUserAnswersCharityHowManyAuthOfficials" must {
      ...
      "convert to isAddAnotherOfficial: true with 2 auth officials" in {
        ...
        Json
          .obj("charityHowManyAuthOfficials" -> Json.toJson(howMany))
          .transform(jsonTransformer.toUserAnswersCharityHowManyAuthOfficials)
          .asOpt
          .value mustBe Json.obj(
      ...
      "do nothing if the question wasn't answered" in {
        ...
        Json
          .obj("charityHowManyAuthOfficials" -> Json.obj())
          .transform(jsonTransformer.toUserAnswersCharityHowManyAuthOfficials)
          .asOpt
          .value mustBe Json.obj()
      }
    ...
    "toUserAnswersCharityHowManyOtherOfficials" must {
      ...
      "convert to addAnotherOtherOfficial: true with 3 other officials" in {
        ...
        Json
          .obj("charityHowManyOtherOfficials" -> Json.toJson(howMany))
          .transform(jsonTransformer.toUserAnswersCharityHowManyOtherOfficials)
          .asOpt
          .value mustBe Json.obj(
      ...
      "do nothing if the question wasn't answered" in {
        ...
        Json
          .obj("charityHowManyOtherOfficials" -> Json.obj())
          .transform(jsonTransformer.toUserAnswersCharityHowManyOtherOfficials)
          .asOpt
          .value mustBe Json.obj()
      }
    ...
    "toOneOfficial" must {
      ...
      "convert to an authorised official with nino and previous address" in {
        ...
        val identity: OfficialIndividualIdentity              = OfficialIndividualIdentity(
          Some("true"),
          "AB111111A",
        ...
        val authOfficial: CharityAuthorisedOfficialIndividual = CharityAuthorisedOfficialIndividual(
          "0001",
          "First",
          "Middle",
          "Last",
        ...
        Json
          .obj("authorisedOfficialIndividual1" -> Json.toJson(authOfficial))
          .transform(jsonTransformer.toOneOfficial(0, "authorised"))
          .asOpt
          .value mustBe Json.parse(
          """{
    ...
    "toUserAnswersCharityAddNominee" must {
      ...
      "convert to correct charityAddNominee" in {
        Json
          .obj("charityAddNominee" -> Json.toJson(CharityAddNominee(None)))
          .transform(jsonTransformer.toUserAnswersCharityAddNominee)
          .asOpt
          .value mustBe Json.parse(
    ...
    "toUserAnswersCharityNomineeStatus" must {
      ...
      "convert to correct charityNomineeStatus" in {
        Json
          .obj("charityNomineeStatus" -> Json.toJson(CharityNomineeStatus(None)))
          .transform(jsonTransformer.toUserAnswersCharityNomineeStatus)
          .asOpt
          .value mustBe Json.obj()
      }
    }
    ...
    "toUserAnswersAcknowledgement" must {
      ...
      "convert to correct Acknowledgement" in {
        Json
          .obj("acknowledgement-Reference" -> Json.toJson(acknowledgement))
          .transform(jsonTransformer.toUserAnswersOldAcknowledgement)
          .asOpt
          .value mustBe Json.obj(
    ...
    "toUserAnswersOperationAndFunds" must {
      ...
      "convert to the correct OperationAndFunds object with foreign countries of operation" in {
        Json
          .obj("operationAndFunds" -> Json.toJson(operationAndFundsFiveCountries))
          .transform(jsonTransformer.toUserAnswersOperationAndFunds)
          .asOpt
          .value mustBe Json.parse("""
            |{
      ...
      "convert to the correct OperationAndFunds object with foreign countries of operation and no UK-Wide" in {
        Json
          .obj("operationAndFunds" -> Json.toJson(operationAndFundsFiveCountriesNoUK))
          .transform(jsonTransformer.toUserAnswersOperationAndFunds)
          .asOpt
          .value mustBe Json.parse("""
            |{
      ...
      "convert to the correct OperationAndFunds object with no foreign countries of operation, UK-Wide" in {
        Json
          .obj("operationAndFunds" -> Json.toJson(operationAndFundsUKWide))
          .transform(jsonTransformer.toUserAnswersOperationAndFunds)
          .asOpt
          .value mustBe Json.parse("""
            |{
