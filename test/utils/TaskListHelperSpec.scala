...
class TaskListHelperSpec extends SpecBase {
  ...
  private def section1(status: String = "notStarted") = TaskListRow(
  ...
  private def section2(status: String = "notStarted") = TaskListRow(
  ...
  private def section3(status: String = "notStarted") = TaskListRow(
  ...
  private def section4(status: String = "notStarted") = TaskListRow(
  ...
  private def section5(status: String = "notStarted") = TaskListRow(
  ...
  private def section6(status: String = "canNotStartYet") = TaskListRow(
  ...
  private def section7(status: String = "notStarted") = TaskListRow(
  ...
  private def section8(status: String = "notStarted") = TaskListRow(
  ...
  private def section9(status: String = "notStarted") = TaskListRow(
  ...
  private def section10(status: String = "canNotStartYet") = TaskListRow(
  ...
  "getTaskListRow" must {
    ...
    "return all rows with not started and Cannot start yet status" in {
      ...
      helper.getTaskListRow mustBe List(
        section1(),
        section2(),
        section3(),
        section4(),
    ...
    "return all rows with completed(section1), inProgress(Section6), not started and Cannot start yet(section10) status" in {
      ...
      implicit val userAnswers: UserAnswers =
        emptyUserAnswers.set(Section1Page, true).flatMap(_.set(Section6Page, false)).success.value
