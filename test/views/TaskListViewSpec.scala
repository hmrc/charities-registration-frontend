...
class TaskListViewSpec extends ViewBehaviours {
  ...
  "TaskList View" must {
    ...
    behave like pageWithAdditionalGuidance(
      ...
      "section.numbers4",
      "section1.label",
      "section1.spoke1.label",
      "section2.label",
      "section2.spoke1.label",
      "section2.spoke2.label",
      "section3.label",
      "section3.spoke1.label",
      "section3.spoke2.label",
      "section3.spoke3.label",
      "section4.label",
      "section4.spoke1.label",
      "section4.spoke2.label",
      "section4.spoke3.label",
      "section5.label",
      "section5.spoke1.label"
    )
    ...
    "Charity contact details row" must {
      behave like pageWithHyperLink(
        ...
        "Enter the charity’s contact details"
      )
    }
    ...
    "Governing document row" must {
      behave like pageWithHyperLink(
        ...
        "Enter governing document details"
      )
    }
    ...
    "Fundraising information row" must {
      behave like pageWithHyperLink(
        ...
        "Enter fundraising and operations details"
      )
    }
    ...
    "Authorised officials row" must {
      behave like pageWithHyperLink(
        ...
        controllers.authorisedOfficials.routes.CharityAuthorisedOfficialsController.onPageLoad().url,
        "Enter details for authorised officials"
      )
    }
    ...
    "Other officials row" must {
      behave like pageWithHyperLink(
        applyView(),
        "other-officials",
        controllers.otherOfficials.routes.CharityOtherOfficialsController.onPageLoad().url,
        "Enter details for other officials"
      )
    }
    ...
    "Nominee row" must {
      behave like pageWithHyperLink(
        applyView(),
        "nominee-info",
        controllers.nominees.routes.CharityNomineeController.onPageLoad().url,
        "Enter details for nominee"
      )
    }
    ...
    "Declaration row" must {
      behave like pageWithHyperLink(
        applyView(),
        "declaration-info",
        controllers.routes.StartDeclarationController.onPageLoad.url,
        "Confirm the declaration and send the supporting documents"
      )
    }

    "dont display declaration message at the bottom pf page if status is completed" in {
      val doc = asDocument(applyView(isCompleted = true))
    ...
    "display switch over message if its not switchover case" in {
      val doc = asDocument(applyView(isCompleted = true, isSwitchOver = Some(true)))
