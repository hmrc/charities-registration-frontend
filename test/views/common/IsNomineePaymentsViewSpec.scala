...
class IsNomineePaymentsViewSpec extends YesNoViewBehaviours {
  ...
  private val messageKeyPrefix: String = "isIndividualNomineePayments"
  ...
  private val view: IsNomineePaymentsView = viewFor[IsNomineePaymentsView](Some(emptyUserAnswers))
