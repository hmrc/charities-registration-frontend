...
class IsBankStatementsViewSpec extends YesNoViewBehaviours {
  ...
  private val messageKeyPrefix: String = "isBankStatements"
  ...
  private val view: IsBankStatementsView = viewFor[IsBankStatementsView](Some(emptyUserAnswers))
