...
class PublicBenefitsViewSpec extends TextAreaViewBehaviours {

  private val messageKeyPrefix: String = "publicBenefits"
  val form: Form[String]               = inject[PublicBenefitsFormProvider].apply()

  private val view: PublicBenefitsView = viewFor[PublicBenefitsView](Some(emptyUserAnswers))
