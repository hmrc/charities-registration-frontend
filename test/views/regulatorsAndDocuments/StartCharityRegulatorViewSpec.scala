...
class StartCharityRegulatorViewSpec extends ViewBehaviours {
  ...
  private val messageKeyPrefix: String = "startCharityRegulator"
  private val section: String          = messages("charityRegulator.section")

  private val view: StartCharityRegulatorView = viewFor[StartCharityRegulatorView](Some(emptyUserAnswers))
  ...
  "StartCharityRegulatorView" when {
